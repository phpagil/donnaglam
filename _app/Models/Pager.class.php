...
class Pager
{
    ...
    private function getSyntax()
    {
        ...
        if ($this->Rows > $this->Limit) :
            ...
            $this->Paginator = "<br clear='all'><div class='pagination-wrap text-right'>";
            $this->Paginator .= "<ul>";
            $this->Paginator .= "<li class='disabled'><a title=\"{$this->First}\" href=\"{$this->Link}1{$this->Hash}\">{$this->First}</a></li>";
            ...
            $this->Paginator .= "<li class=\"active\"><a href='#'>{$this->Page}</a></li>";
            ...
            $this->Paginator .= "<li class='next'><a title=\"{$this->Last}\" href=\"{$this->Link}{$Paginas}{$this->Hash}\">{$this->Last}</a></li>";
            $this->Paginator .= "</ul>";
            $this->Paginator .= "</div><br clear='all'>";
        endif;
    }
}
