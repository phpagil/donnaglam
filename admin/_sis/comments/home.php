...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()) :
        ...
        foreach ($Read->getResult() as $Comm) :
            ...
            if (!$Read->getResult()) :
                echo "<a href='#{$Comm['id']}' class='wc_comment_action font_blue' rel='{$Comm['id']}' action='like' href='Gostei do Comentário' title='Gostei do Comentário'>Curtir</a>";
            endif;
            ...
            if ($Read->getResult()) :
                foreach ($Read->getResult() as $Response) :
                    ...
                    if (!$Read->getResult()) :
                        echo "<a href='#{$Response['id']}' class='wc_comment_action font_blue' rel='{$Response['id']}' action='like' href='Gostei do Comentário' title='Gostei do Comentário'>Curtir</a>";
                    endif;
