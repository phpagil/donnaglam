...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search">
        <a title="Novo Slide" href="dashboard.php?wc=slide/create" class="btn btn_blue icon-plus">Novo Slide</a>
    </div>
</header>
<div class="dashboard_content">
    ...
    $Read->ExeRead(DB_SLIDES, "WHERE slide_start <= NOW() AND (slide_end >= NOW() OR slide_end IS NULL) ORDER BY slide_date DESC LIMIT :limit OFFSET :offset", "limit={$Pager->getLimit()}&offset={$Pager->getOffset()}");
    if (!$Read->getResult()) :
        $Pager->ReturnPage();
