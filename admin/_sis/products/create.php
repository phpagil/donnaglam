    ...
    <form class="auto_save" name="manage_pdt" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="box box70">
            <div class="box_content">
                ...
                <div class="label_50">
                    <label class="label">
                        <span class="legend">Preço R$ ( <span style="color:#333333;">Exemplo = 100,00</span> ) :</span>
                    ...
                    <label class="label">
                        <span class="legend">Estoque ( -1 para <span style="color:#333333;">Produto Sob Encomenda</span> ) :</span>
                ...
                <span class="section icon-box-remove">DIMENSÕES DO PRODUTO ( L x A x C ) :</span>
                <div class="label_50">
                    <label class="label">
                ...
                <div class="label_50">
                    <label class="label">
                        <span class="legend">Comprimento Em Centímetros:</span>
