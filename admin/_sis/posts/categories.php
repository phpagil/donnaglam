...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()) :
        echo Erro("<span class='al_center icon-notification'>Ainda não existem categorias cadastradas {$Admin['user_name']}. Comece agora mesmo criando sua primera sessão e então suas categorias!</span>", E_USER_NOTICE);
    else :
