...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-new-tab">Cadastrar Novo Post</h1>
    ...
    <form class="auto_save" name="post_create" action="" method="post" enctype="multipart/form-data">
        ...
        <article class="box box70">
            <div class="box_content">
                ...
                <label class="label">
                    ...
                    <input style="font-size: 1.5em;" type="text" name="post_title" value="<?= $post_title; ?>" required />
                </label>
        ...
        <article class="box box30">
                    ...
                    foreach ($Read->getResult() as $Categories) :
                        ...
                        if ($Read->getResult()) :
                            ...
                            foreach ($Read->getResult() as $SubCategories) :
                                ...
                                if (strstr($post_category_parent, $SubCategories['category_id'])) :
                                    echo " checked";
                                endif;
            ...
            <div class="box_content">
                ...
                <div class="m_top">&nbsp;</div>
                <label class="label_check"><input style="margin-top: -1px;" type="checkbox" value="1" name="post_status" <?= ($post_status == 1 || empty($post_title) ? 'checked' : ''); ?>> Publicar Agora!</label>
