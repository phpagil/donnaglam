        ...
        foreach ($Read->getResult() as $REALTY) :
            ...
            echo "<article class='box box25 imobi_single' id='{$realty_id}'>
                <div class='post_single_cover'>
                    ...
                    <div class='post_single_cat'>{$RealTyType} " . getWcRealtyFinality($realty_finality) . ($realty_observation ? " - <b>{$realty_observation}</b>" : null) . "</div>
                </div>
                <div class='box_content'>
                    <p class='info icon-info'>{$realty_ref} - " . getWcRealtyTransaction($realty_transaction) . "</p>
