...
if ($RealtyId) :
    ...
    $ImobiCreate = ['realty_date' => date('Y-m-d H:i:s')];
...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-home3">Cadastrar Imóvel</h1>
...
<div class="dashboard_content">
    <form class="auto_save" autocomplete="off" name="realty_create" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="box_content">
                ...
                <div class="label_50">
                    ...
                    <label class="label">
                        ...
                        <input style="font-size: 1.5em;" type="text" name="realty_price" value="<?= ($realty_price ? number_format($realty_price, 2, ',', '.') : ''); ?>" required />
                    </label>
                </div>
        ...
        <article class="box box30">
            ...
            ?>
            <img class="realty_cover" alt="Capa" title="Capa" src="../tim.php?src=<?= $RealtyCover; ?>&w=<?= IMAGE_W; ?>&h=<?= IMAGE_H; ?>" default="../tim.php?src=<?= $RealtyCover; ?>&w=<?= IMAGE_W; ?>&h=<?= IMAGE_H; ?>" />
            <?php
            ...
            <div class="box_content">
                ...
                <div class="m_top">&nbsp;</div>
                <label class="label_check"><input style="margin-top: -1px;" type="checkbox" value="1" name="realty_status" <?= ($realty_status == 1 || empty($realty_title) ? 'checked' : ''); ?>> Publicar!</label>
                ...
                <button name="public" value="1" class="btn btn_green fl_right icon-share" style="margin-left: 5px;">Atualizar Imóvel!</button>
