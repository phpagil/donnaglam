...
<html lang="pt-br">
    ...
    <body class="login">
        <div class="container">
            <div class="login_box">
                <img class="login_logo" alt="<?= ADMIN_NAME; ?>" title="<?= ADMIN_NAME; ?>" src="_img/adm_img.png"/>
                <form class="login_form" name="work_login" action="" method="post" enctype="multipart/form-data">
                    ...
                    <button class="btn btn_green" style="width: 100%">Entrar</button>
                    <div class="clear"></div>
                </form>
                <p class="login_link"><a href="../">&larrhk; Voltar para <?= SITE_NAME; ?>!</a> &nbsp;&nbsp;&nbsp; <a href="recover.php">Esqueceu sua senha?</a></p>
            </div>
        </div>
