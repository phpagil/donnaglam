  ...
  r(l, [], function () {
    ...
    r(f, [c, l, u, d], function (e, n, r, i) {
      ...
      function l(e, t, n, r) {
        ...
        if (a(t)) t = s(t, g(e[0]));
          ...
          else for (i = 0; i < t.length; i++) l(e, t[i], n, r);
          return e;
        }
      ...
      function v(e, n, r) {
        var i = [],
          o = e[n];
        for (
          'string' != typeof r && r instanceof d && (r = r[0]);
          o && 9 !== o.nodeType;
      ...
      var x = document,
        ...
        R = { for: 'htmlFor', class: 'className', readonly: 'readOnly' },
        A = { float: 'cssFloat' },
        B = {},
        D = {},
        L = /^\s*|\s*$/g;
        ...
        (d.fn = d.prototype =
          {
            ...
            add: function (e, t) {
              ...
              if (t !== !1)
                for (
                  r = d.unique(n.toArray().concat(d.makeArray(e))),
                    n.length = r.length,
                    i = 0;
                  i < r.length;
                  i++
    ...
    r(v, [], function () {
      return function (e, t) {
        ...
        function r(t, r, s) {
          ...
          function d(e, t) {
            e() ||
              (new Date().getTime() - g < a ? window.setTimeout(t, 0) : c());
          }
          function f() {
            d(function () {
          ...
          var h, m, g, v;
          if (
            (o[t] ? (v = o[t]) : ((v = { passed: [], failed: [] }), (o[t] = v)),
            r && v.passed.push(r),
            s && v.failed.push(s),
            1 != v.status)
          ) {
    ...
    r(w, [x], function (e) {
      return function (t) {
        function n(e) {
          var n, r;
          if (
            ((r = t.$(e).parentsUntil(t.getBody()).add(e)),
            r.length === i.length)
          ) {
        ...
        'onselectionchange' in t.getDoc() ||
          t.on('NodeChange Click MouseUp KeyUp', function (n) {
            var i, o;
            (i = t.selection.getRng()),
              ...
              ('nodechange' != n.type && e.compareRanges(o, r)) ||
          ...
          (this.nodeChanged = function (e) {
            var n = t.selection,
              ...
              o;
            !t.initialized ||
              t.settings.disable_nodechange ||
              t.settings.readonly ||
              ((o = t.getBody()),
              (r = n.getStart() || o),
              (r = r.ownerDocument != t.getDoc() ? t.getBody() : r),
    ...
    r(E, [u], function (e) {
      ...
      function n(e) {
        ...
        function r(e, n) {
          ...
          for (e = t(e), r = e.length, n = t(n); r--; )
            for (i = o[e[r]], a = 0, s = n.length; s > a; a++)
              (i.attributes[n[a]] = {}), i.attributesOrder.push(n[a]);
        }
        var o = {},
          s,
          l,
      ...
      return function (e) {
        function u(t, n, r) {
          ...
          return (
            a
              ? (a = o(a, /[, ]/, o(a.toUpperCase(), /[, ]/)))
              : ((a = i[t]),
                a ||
                  ((a = o(n, ' ', o(n.toUpperCase(), ' '))),
                  (a = s(a, r)),
                  (i[t] = a))),
            a
          );
        ...
        (e = e || {}),
          ...
          m('+ol[ul|ol],+ul[ul|ol]'),
          e.invalid_elements &&
            a(l(e.invalid_elements), function (e) {
              y[e] && delete y[e];
            }),
      ...
      return function (r, i) {
        ...
        function u(e) {
          ...
          return (
            ...
            (n = C.$(n).closest(z ? 'table' : 'table,img,hr')[0]),
            t(n, U) &&
            (v(),
            t(r.getStart(), n) &&
              t(r.getEnd(), n) &&
              (!z || (n != r.getStart() && 'IMG' !== r.getStart().nodeName)))
              ? void l(n)
              : void c()
          );
        }
        ...
        return (
          i.contentStyles.push(
            j +
              ' div.mce-resizehandle {position: absolute;border: 1px solid black;background: #111111;width: 5px;height: 5px;z-index: 10000}' +
              j +
              ...
              j +
              ' .mce-resize-helper {background-color: #555;background-color: rgba(0,0,0,0.75);border-radius: 3px;border: 1px;color: white;display: none;font-family: sans-serif;font-size: 12px;white-space: nowrap;line-height: 14px;margin: 5px 10px;padding: 5px;position: absolute;z-index: 10001}'
          ),
          i.on('init', function () {
            z
        ...
        (l.prototype = {
          ...
          getStart: function () {
            ...
            return (
              ...
              1 == n.nodeType &&
                ...
                (n =
                  n.childNodes[
                    Math.min(n.childNodes.length - 1, t.startOffset)
                  ]),
          ...
          normalize: function () {
            var e = this,
              t = e.getRng();
            return (
              !d && new i(e.dom).normalize(t) && e.setRng(t, e.isForward()), t
            );
          },
      ...
      return function (a) {
        ...
        function u() {
          p({
            ...
            removeformat: [
              {
                selector:
                  'b,strong,em,i,font,u,strike,sub,sup,dfn,code,samp,kbd,var,cite,mark,q',
                remove: 'all',
                split: !0,
                expand: !1,
                block_expand: !0,
        ...
        function m(e) {
          ...
          1 === e.nodeType &&
            ...
            a.dom.getStyle(e, 'color') && t
              ...
              : a.dom.getStyle(e, 'textdecoration') === t &&
        ...
        function g(t, n, r) {
              ...
              U.walk(e, function (e) {
                function r(e) {
                  ...
                  return (
                    ...
                    (g = e.parentNode.nodeName.toLowerCase()),
                    1 === e.nodeType &&
                      et(e) &&
                      ((x = p), (p = 'true' === et(e)), (C = !0)),
                    k(m, 'br')
                      ? ((h = 0), void (d.block && W.remove(e)))
                      : d.wrapper && b(e, t, n)
                      ? void (h = 0)
                      : p && !C && d.block && !d.wrapper && s(m) && $(g, l)
                      ? ((e = W.rename(e, l)), i(e), a.push(e), void (h = 0))
                      : d.selector &&
                        (it(u, function (t) {
                          ('collapsed' in t && t.collapsed !== v) ||
                            (W.is(e, t.selector) &&
                              !c(e) &&
                              (i(e, t), (y = !0)));
                        }),
              ...
              it(a, function (e) {
                ...
                if (d.inline || d.wrapper) {
                  if (
                    ...
                    return W.remove(e, 1), (e = 0), J;
                  d.merge_with_parents &&
                    W.getParent(e.parentNode, function (r) {
                      return b(r, t, n) ? (W.remove(e, 1), (e = 0), J) : void 0;
                    }),
                    e &&
                      d.merge_siblings !== !1 &&
                      ((e = P(M(e), e)), (e = P(e, M(e, J))));
                }
              });
          }
          var u = f(t),
          ...
          if (d)
            if (r)
              ...
              v &&
              d.inline &&
              !W.select('td.mce-item-selected,th.mce-item-selected').length
            )
              I('apply', t, n);
            else {
        ...
        function v(e, t, n, r) {
          ...
          function o(n) {
            var i;
            return (
              it(l(n.parentNode).reverse(), function (n) {
                var o;
                i ||
                  '_start' == n.id ||
                  '_end' == n.id ||
                  ((o = b(n, e, t, r)), o && o.split !== !1 && (i = n));
              }),
              i
            );
          }
          ...
          function u(e) {
            ...
            return (
              rt(n) && (n = n[e ? 'firstChild' : 'lastChild']),
              W.remove(t, !0),
              n
            );
          }
            ...
            : void (V.isCollapsed() &&
              ...
              !W.select('td.mce-item-selected,th.mce-item-selected').length
                ...
                : ((g = V.getBookmark()),
                  d(V.getRng(J)),
                  V.moveToBookmark(g),
                  m.inline && C(e, t, V.getStart()) && F(V.getRng(!0)),
                  a.nodeChanged()));
        }
        function y(e, t, n) {
          var r = f(e);
          !C(e, t, n) || ('toggle' in r[0] && !r[0].toggle)
            ? g(e, t, n)
            : v(e, t, n);
        }
        function b(e, t, n, r) {
              ...
              if (s.length === Z) {
                for (o in s)
                  if (s.hasOwnProperty(o)) {
                    if (
                      ((a = 'attributes' === i ? W.getAttrib(e, o) : S(e, o)),
                      r && !a && !t.exact)
                    )
                      return;
        ...
        function C(e, t, n) {
          ...
          return n
            ? r(n)
            : ((n = V.getNode()),
              r(n) ? J : ((i = V.getStart()), i != n && r(i) ? J : X));
        }
        function x(e, t) {
          var n,
            r = [],
        ...
        function N(e, t) {
          return k(e, t.inline)
            ...
            ? J
            : t.selector
            ? 1 == e.nodeType && W.is(e, t.selector)
            : void 0;
        }
        function k(e, t) {
          return (
        ...
        function T(e, t) {
          return (
            ('color' == t || 'backgroundColor' == t) && (e = W.toHex(e)),
        ...
        function D(t, n, r) {
          ...
          function u(t, n, i) {
            ...
            for (
              s = new e(t, W.getParent(t, q) || a.getBody());
              (l = s[i ? 'prev' : 'next']());
          ...
          function f(e, t) {
            var r,
              i = W.getRoot();
            if (
              (n[0].wrapper || (r = W.getParent(e, n[0].block, i)),
              r ||
                (r = W.getParent(
          ...
          if (
            ...
            (g = c(g)),
            (y = c(y)),
            (rt(g.parentNode) || rt(g)) &&
              ((g = rt(g) ? g : g.parentNode),
              (g = g.nextSibling || g),
              3 == g.nodeType && (v = 0)),
            (rt(y.parentNode) || rt(y)) &&
              ((y = rt(y) ? y : y.parentNode),
          ...
          return (
            ...
            (n[0].block || n[0].selector) &&
              ...
              (y = f(y, 'nextSibling')),
              n[0].block && (q(g) || (g = i(!0)), q(y) || (y = i()))),
            1 == g.nodeType && ((v = K(g)), (g = g.parentNode)),
            1 == y.nodeType && ((b = K(y) + 1), (y = y.parentNode)),
        ...
        function L(e, t, n, r) {
          ...
          if ('all' != e.remove)
            for (
              it(e.styles, function (i, o) {
                (i = T(R(i, t), o)),
                  'number' == typeof o && ((o = i), (r = 0)),
                  (e.remove_similar || !r || k(S(r, o), i)) &&
                    W.setStyle(n, o, ''),
                  (a = 1);
              }),
                a &&
        ...
        function H(e, t) {
          ...
          t.block &&
            (j
              ? r == W.getRoot() &&
                ((t.list_block && k(e, t.list_block)) ||
                  it(ot(e.childNodes), function (e) {
                    $(j, e.nodeName.toLowerCase())
                      ? i
                        ? i.appendChild(e)
                        : ((i = B(e, j)),
                          W.setAttribs(i, a.settings.forced_root_block_attrs))
                      : (i = 0);
                  }))
              : q(e) &&
                !q(r) &&
                (n(e, X) ||
                  n(e.firstChild, J, 1) ||
                  e.insertBefore(W.create('br'), e.firstChild),
                n(e, J) ||
                  n(e.lastChild, X, 1) ||
                  e.appendChild(W.create('br')))),
            ...
            if (d)
              if (c)
                ...
                for (m = o(), u = m, h = p.length - 1; h >= 0; h--)
                  u.appendChild(W.clone(p[h], !1)), (u = u.firstChild);
                ...
                at(
                  ...
                  function (e) {
                    1 != e.nodeType ||
                      e.id === y ||
                      W.isEmpty(e) ||
                      W.setAttrib(e, 'data-mce-bogus', null);
                  },
                  'childNodes'
                );
          }
        ...
        function F(t) {
          ...
          if (
            ...
            for (
              ...
              if (3 == a.nodeType && !A(a))
                return (
                  (l = W.create('a', { 'data-mce-bogus': 'all' }, Y)),
    ...
    r(I, [d, u, N], function (e, t, n) {
      ...
      return (
        ...
        function (t) {
          function o() {
            var e = r(t.getContent({ format: 'raw', no_events: 1 })),
              ...
              d = t.schema;
            for (
              e = e.replace(i, ''), u = d.getShortEndedElements();
              (c = o.exec(e));
          ...
          return (
            ...
            t.on('KeyUp', function (n) {
              ...
              ((r >= 33 && 36 >= r) ||
                ...
                d &&
                  s.typing &&
                  (t.isDirty() ||
                    ((t.isNotDirty = !c[0] || o() == c[0].content),
                    t.isNotDirty ||
                      t.fire('change', { level: c[0], lastLevel: null })),
                  t.fire('TypingUndo'),
                  (d = !1),
                  t.nodeChanged());
            }),
            t.on('KeyDown', function (e) {
              ...
              return (t >= 33 && 36 >= t) || (t >= 37 && 40 >= t) || 45 == t
                ...
                : void (
                    ...
                    91 != t &&
                    !s.typing &&
                    (s.beforeChange(), (s.typing = !0), s.add({}, e), (d = !0))
                  );
            }),
            ...
            (s = {
              ...
              add: function (e, n) {
                ...
                if (
                  (c[l] && (c[l].beforeBookmark = u),
                  i.custom_undo_redo_levels &&
                    c.length > i.custom_undo_redo_levels)
                ) {
                ...
                return (
                  t.fire('AddUndo', s),
                  l > 0 && ((t.isNotDirty = !1), t.fire('change', s)),
                  e
                );
              },
              undo: function () {
      ...
      return function (i) {
        function o(o) {
          ...
          function y(t) {
            ...
            if (
              'TABLE' === T.nodeName ||
              (T.previousSibling && 'TABLE' == T.previousSibling.nodeName)
            )
              return (F && !t) || (!F && t);
            for (
              n = new e(T, A),
          ...
          function b(e, t) {
            ...
            if (
              ...
              if (o && u.isValidChild(c, d.toLowerCase())) {
                for (
                  n = a.create(d), g(n), o.parentNode.insertBefore(n, o), s = o;
                  s && !a.isBlock(s);
          ...
          function C() {
            function e(e) {
              for (
                var t = M[e ? 'firstChild' : 'lastChild'];
                t && 1 != t.nodeType;
            ...
            /^(OL|UL|LI)$/.test(n) && (I = 'LI'),
              ...
              e(!0) && e()
                ...
                ? 'LI' == n
                  ? (a.insertAfter(L, t()),
                    L.appendChild(a.doc.createTextNode(' ')),
                    L.appendChild(M))
                  : M.parentNode.insertBefore(L, M)
                : e()
                ? (a.insertAfter(L, t()), p(L))
                : ((M = t()),
                  (k = N.cloneRange()),
                  k.setStartAfter(A),
                  k.setEndAfter(M),
                  (H = k.extractContents()),
                  'LI' == I && 'LI' == H.firstChild.nodeName
                    ? ((L = H.firstChild), a.insertAfter(H, M))
                    : (a.insertAfter(H, M), a.insertAfter(L, M))),
              a.remove(A),
              m(L),
              c.add();
          }
          ...
          if (((N = s.getRng(!0)), !o.isDefaultPrevented())) {
            ...
            if (
              ...
              if (
                ...
                (M = A ? a.getParent(A.parentNode, a.isBlock) : null),
                (P = A ? A.nodeName.toUpperCase() : ''),
                (O = M ? M.nodeName.toUpperCase() : ''),
                'LI' != O || o.ctrlKey || ((A = M), (P = O)),
                /^(LI|DT|DD)$/.test(P))
              ) {
              ...
              (I && A === i.getBody()) ||
                ...
                y()
                  ? ((L =
                      /^(H[1-6]|PRE|FIGURE)$/.test(P) && 'HGROUP' != O
                        ? v(I)
                        : v()),
                    l.end_container_on_empty_block && f(M) && a.isEmpty(A)
                      ? (L = a.split(M, A))
                      : a.insertAfter(L, A),
                    m(L))
                  : y(!0)
                  ? ((L = A.parentNode.insertBefore(v(), A)), p(L), m(A))
                  : ((k = N.cloneRange()),
                    k.setEndAfter(A),
                    (H = k.extractContents()),
                    w(H),
          ...
          C({
            ...
            mceInsertContent: function (t, n, o) {
              ...
              var u,
                ...
                x,
                w,
                _ = r.schema.getTextInlineElements();
              'string' != typeof o && ((w = o.merge), (o = o.content)),
                ...
                (g = { content: o, format: 'html', selection: !0 }),
              ...
              var E =
                  y.startContainer ||
                  (y.parentElement ? y.parentElement() : null),
                N = r.getBody();
              E === N &&
                S.isCollapsed() &&
                k.isBlock(N.firstChild) &&
                k.isEmpty(N.firstChild) &&
                ((y = k.createRng()),
                ...
                b && 3 == b.nodeType
                  ? (y.setStart(b, b.nodeValue.length),
                    p ||
                      ...
                      C &&
                        3 == C.nodeType &&
                        (b.appendData(C.data), C.parentNode.removeChild(C))))
                  : (y.setStartBefore(v), y.setEndBefore(v)),
                k.remove(v),
                S.setRng(y),
                r.fire('SetContent', g),
                r.addVisual();
            ...
            'Indent,Outdent': function (e) {
              ...
              (t = R.indentation),
                ...
                y('InsertUnorderedList') || y('InsertOrderedList')
                  ? x(e)
                  : (R.forced_root_block ||
                      k.getParent(S.getNode(), k.isBlock) ||
                      A.apply('div'),
            ...
            mceReplaceContent: function (e, t, n) {
              r.execCommand(
                'mceInsertContent',
                !1,
                n.replace(/\{\$selection\}/g, S.getContent({ format: 'text' }))
              );
            },
            ...
            delete: function () {
              ...
              k.isEmpty(e) &&
                (r.setContent(''),
                e.firstChild && k.isBlock(e.firstChild)
            ...
            InsertLineBreak: function (e, t, n) {
              ...
              return (
                h &&
                  'PRE' == y &&
                  (!w || 8 > w) &&
                  l.parentNode.insertBefore(k.doc.createTextNode('\r'), l),
                (u = k.create('span', {}, '&nbsp;')),
          ...
          C(
            {
              ...
              Outdent: function () {
                ...
                if (R.inline_styles) {
                  if (
                    (e = k.getParent(S.getStart(), k.isBlock)) &&
                    parseInt(e.style.paddingLeft, 10) > 0
                  )
                    return m;
                  if (
                    (e = k.getParent(S.getEnd(), k.isBlock)) &&
                    parseInt(e.style.paddingLeft, 10) > 0
                  )
                    return m;
                }
                return (
                  ...
                  y('InsertOrderedList') ||
                  (!R.inline_styles && !!k.getParent(S.getNode(), 'BLOCKQUOTE'))
                );
              },
              'InsertUnorderedList,InsertOrderedList': function (e) {
            ...
            for (o = e.toLowerCase().split(' '), n = o.length; n--; ) {
              ...
              if (r) {
                if (t)
                  for (a = r.length; a--; )
                    r[a] === t &&
                      ((r = r.slice(0, a).concat(r.slice(a + 1))), (u[e] = r));
                else r.length = 0;
    ...
    r(Y, [U, u, $, j, K], function (e, t, n, r, i) {
      ...
      var a = {},
        ...
        c = 'mce-',
        u = e.extend({
          Statics: { elementIdCache: a, classPrefix: c },
          isRtl: function () {
            return u.rtl;
          },
          classPrefix: c,
          ...
          bindPendingEvents: function () {
            ...
            if (((o._rendered = !0), (f = o._nativeEvents))) {
              for (
                u = o.parents().toArray(), u.unshift(o), a = 0, c = u.length;
                !d && c > a;
                a++
              )
                d = u[a]._eventsRoot;
        ...
        m = e.extend({
          ...
          init: function (e) {
            function t() {
              ...
              i
                ? r.css(o, 'z-index', i.zIndex - 1)
                : o && (o.parentNode.removeChild(o), (h = !1)),
                (m.currentZIndex = t);
            }
            var n = this;
            n._super(e),
      ...
      return function (a) {
            ...
            o.each(a.getBody().getElementsByTagName('*'), function (e) {
              'SPAN' == e.tagName && e.setAttribute('mce-data-marked', 1),
                !e.hasAttribute('data-mce-style') &&
                  ...
                  a.dom.setAttrib(e, 'style', e.getAttribute('style'));
            }),
              t.observe(a.getDoc(), {
                childList: !0,
                attributes: !0,
              ...
              if (!c(n) && (r || n.keyCode == U)) {
                ...
                n.preventDefault(),
                  i &&
                    a.selection
                      .getSel()
                      .modify('extend', r ? 'forward' : 'backward', 'word'),
                  t(r);
              }
            }),
                ...
                a.selection.isCollapsed() &&
                  ...
                  t.length > 0 &&
                    e.dataTransfer.setData(
                      'URL',
                      'data:text/mce-internal,' + escape(t)
                    );
              }),
        ...
        function d() {
          ...
          a.on('keydown', function (e) {
            ...
            if (!c(e) && (t == $ || t == U)) {
              ...
              e.preventDefault(),
                a.setContent(''),
                i.firstChild && q.isBlock(i.firstChild)
                  ? a.selection.setCursorLocation(i.firstChild, 0)
                  : a.selection.setCursorLocation(i, 0),
                a.nodeChanged();
            }
          });
        }
        ...
        function g() {
          a.on('click', function (e) {
            (e = e.target),
              /^(IMG|HR)$/.test(e.nodeName) &&
                j.getSel().setBaseAndExtent(e, 0, e, 1),
              'A' == e.nodeName &&
                q.hasClass(e, 'mce-item-anchor') &&
                j.select(e);
          });
        }
        function v() {
          ...
          function t() {
            return (
              !j.isCollapsed() &&
              q.getParent(j.getStart(), q.isBlock) !=
                q.getParent(j.getEnd(), q.isBlock)
            );
          }
          a.on('keypress', function (n) {
            var r;
        ...
        function w() {
          q.bind(a.getBody(), 'mouseup', function () {
            var e,
              t = j.getNode();
            'IMG' == t.nodeName &&
              ((e = q.getStyle(t, 'width')) &&
                (q.setAttrib(t, 'width', e.replace(/[^0-9%]+/g, '')),
                q.setStyle(t, 'width', '')),
              (e = q.getStyle(t, 'height')) &&
                (q.setAttrib(t, 'height', e.replace(/[^0-9%]+/g, '')),
                q.setStyle(t, 'height', '')));
          });
        }
        function _() {
        ...
        function E() {
          function e() {
            a._refreshContentEditable(),
              ...
              K.object_resizing || s('enableObjectResizing', !1);
          }
        ...
        function R() {
          ...
          l() >= 10 &&
            ((e = ''),
            V('p div h1 h2 h3 h4 h5 h6'.split(' '), function (t, n) {
              e += (n > 0 ? ',' : '') + t + ':empty';
            }),
          ...
          a.inline ||
            ...
            a.on('click', function (e) {
              'HTML' == e.target.nodeName &&
                (a.getBody().focus(), a.selection.normalize(), a.nodeChanged());
            }));
        }
        function P() {
          i.mac &&
      ...
      function i(e, t) {
        ...
        if (n) {
          if (
            ...
            return;
          a == e.getBody() && ((a = o.select(n)[0]), (i.eventRootElm = a)),
            (i.rootEvents[t] = !0),
            o.bind(a, t, function (e) {
              for (var n = e.target, r = i.editors, a = r.length; a--; ) {
                var s = r[a].getBody();
                (s === n || o.isChildOf(n, s)) &&
                  (r[a].hidden || r[a].fire(t, e));
              }
            });
        } else
            ...
            n.settings.readonly ||
              ('focus' != e &&
                ...
                (t
                  ...
                  : n.initialized && n.dom.unbind(r(n, e), e)));
          },
        };
              ...
              R(
                {
                  ...
                  indent: 'simple',
                  indent_before:
                    'p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,ul,ol,li,dl,dt,dd,area,table,thead,tfoot,tbody,tr,section,article,hgroup,aside,figure,option,optgroup,datalist',
                  indent_after:
                    'p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,ul,ol,li,dl,dt,dd,area,table,thead,tfoot,tbody,tr,section,article,hgroup,aside,figure,option,optgroup,datalist',
                  validate: !0,
          ...
          (N.prototype = {
            ...
            init: function () {
              ...
              for (
                ...
                (t.iframeHTML +=
                  '<link type="text/css" rel="stylesheet" href="' + g + '" />'),
                  (t.loadedCSS[g] = !0);
              }
              (d = n.body_id || 'tinymce'),
                -1 != d.indexOf('=') &&
            ...
            initContentBody: function (t) {
              ...
              r.inline || (n.getElement().style.visibility = n.orgVisibility),
                ...
                r.readonly ||
                  (n.inline &&
                    'static' == k.getStyle(m, 'position', !0) &&
                ...
                r.browser_spellcheck ||
                  r.gecko_spellcheck ||
                  ((h.body.spellcheck = !1),
                  k.setAttrib(m, 'spellcheck', 'false')),
                n.fire('PostRender'),
                (n.quirks = new C(n)),
            ...
            focus: function (e) {
              ...
              if (!e) {
                if (
                  ...
                  i || (x.opera || n.getBody().focus(), n.getWin().focus()),
                  P || i)
                ) {
              ...
              if (!e.removed) {
                e.save(),
                  ...
                  e.inline ||
                    (O &&
                      10 > O &&
                      e.getDoc().execCommand('SelectAll', !1, null),
                    k.setStyle(e.id, 'display', e.orgDisplay),
          ...
          d.on('init', function () {
            (d.inline || t.ie) &&
              ('onbeforedeactivate' in document && t.ie < 9
                ? d.dom.bind(d.getBody(), 'beforedeactivate', function () {
                    try {
                  ...
                  case 'exact':
                    (u = t.elements || ''),
                      u.length > 0 &&
                        p(f(u), function (n) {
                          d.get(n)
                            ? ((c = new e(n, t, s)), l.push(c), c.render())
                            : p(document.forms, function (e) {
        ...
        send: function (e) {
          ...
          if (
            ...
            if (
              ...
              e.content_type &&
                n.setRequestHeader('Content-Type', e.content_type),
          ...
          if (
            ...
            for (
              ...
              (p = r[t]),
                ...
                (y = h.maxFlexSize || h[N]),
                'center' === s
                  ? (x[D] = Math.round(i[L] / 2 - h[H] / 2))
                  : 'stretch' === s
                  ? ((x[H] = z(h[M] || 0, i[L] - o[P] - o[O])), (x[D] = o[P]))
                  : 'end' === s && (x[D] = i[L] - h[H] - o.top),
                h.flex > 0 && (y += h.flex * C),
                (x[E] = y),
                (x[k] = w),
                p.layoutRect(x),
      ...
      return e.extend({
        ...
        renderHtml: function () {
          var e = this,
            ...
            l = r.shortcut;
          return (
            a && e.parent().addClass('menu-has-icons'),
            r.image &&
              ((a = 'none'),
              (s = ' style="background-image: url(\'' + r.image + '\')"')),
            l &&
              n.mac &&
              ((l = l.replace(/ctrl\+alt\+/i, '&#x2325;&#x2318;')),
              (l = l.replace(/ctrl\+/i, '&#x2318;')),
              (l = l.replace(/alt\+/i, '&#x2325;')),
              (l = l.replace(/shift\+/i, '&#x21E7;'))),
      ...
      return e.extend({
        ...
        renderHtml: function () {
          ...
          return (
            ...
            (e._menuBtnText ? (r ? '\xa0' : '') + e._menuBtnText : '') +
            ' <i class="' +
            n +
            'caret"></i></button></div>'
          );
