    ...
    switch ($Case):
        ...
        case 'admin_login':
            if (in_array('', $PostData)):
                ...
                elseif (strlen($PostData['user_password']) < 5 || strlen($PostData['user_password']) > 11):
        ...
        case 'admin_newpass':
            if (empty($_SESSION['RecoverPass'])):
                ...
                elseif (strlen($PostData['user_password']) < 5 || strlen($PostData['user_password']) > 11):
                    $jSON['trigger'] = AjaxErro('<b>ALERTA:</b> Informe uma senha com no mínimo 5 caracteres e no máximo 11 caracters!', E_USER_WARNING);
