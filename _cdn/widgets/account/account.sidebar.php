...
echo "<li><a " . ($AccountAction == 'dados' ? 'class="active"' : '') . " href='{$AccountBaseUI}/dados#acc' title='Atualizar Dados'>Atualizar Cadastro</a></li>";
echo "<li><a class='logoff' href='{$AccountBaseUI}/sair' title='Desconectar'>Sair</a></li>";
echo "</ul>";
echo "</nav>";
echo "</aside>";
