<form name="add_comment" action="" method="post" enctype="multipart/form-data">
    ...
    <label>
        <select name="rank" required>
            <option disabled value="">Qual sua nota para esse produto ?</option>
    ...
    <button style="padding-top: 12px; padding-bottom: 12px; " class="btn btn_blue">Enviar Comentários</button>
