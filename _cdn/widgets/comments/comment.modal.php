        ...
        <form name='comment_login' class="ajax_off wc_comment_login" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="comment_login_fields">
                ...
                <label class="comment_label comment_login_create">
                    <span>Nome :</span>
                    <input type="text" name="user_name" placeholder="Informe o nome ..."/>
                </label>

                <label class="comment_label comment_login_create">
                    <span>Sobrenome :</span>
                    <input type="text" name="user_lastname" placeholder="Informe o sobrenome ..."/>
                </label>
                ...
                <label class="comment_recover_label">
                    <span>ENVIAMOS SEU CÓDIGO PARA: <b>ROBSONVLEITE@GMAIL.COM</b></span>
