...
<?php if (ECOMMERCE_PAY_SPLIT): ?>
    ...
    <form id="card" autocomplete="off" name="workcontrol_pagseguro" class="workcontrol_pagseguro" action="" method="post">
        ...
        <div class="labelline labelactions">
            ...
            <button class="btn btn_green wc_button_cart fl_right">Finalizar</button>
        </div>
        <div class="clear"></div>
    </form>
<?php endif; ?>
...
<form id="billet" <?= (!ECOMMERCE_PAY_SPLIT ? 'style="display: block;"' : ''); ?> autocomplete="off" name="workcontrol_pagseguro" class="workcontrol_pagseguro workcontrol_pagseguro_billet" action="" method="post">
    <div>
        ...
        <p>Pode ser compensado em qualquer agência bancária ou casa lotérica até sua data de vencimento.</p>
        <p>Pagamentos efetuados via boleto podem levar até 3 dias úteis para serem processados.</p>
...
<!--<div class="workcontrol_pagseguro_logo"><img title="Pagamento processado pelo PagSeguro!" alt="Pagamento processado pelo PagSeguro!" src="<?= BASE; ?>/_cdn/widgets/ecommerce/PagSeguro/pagseguro.gif"></div>-->
<div class="workcontrol_pagseguro_logo"><img title="Pagamento processado pelo PagSeguro!" alt="Pagamento processado pelo PagSeguro!" src="<?= BASE; ?>/_cdn/widgets/ecommerce/PagSeguro/banner.png"></div>